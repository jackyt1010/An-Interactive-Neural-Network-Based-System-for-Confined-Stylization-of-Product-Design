...
When you use the funationallity "GrabCut", you need to press the "Enter" button of the keyboard twice in order to make the content image to be segmented successfully
